...
public abstract class AbstractDAO<T extends Object> {
	...
	/**
	 * Sucht eine Sehenswürdigkeit anhand ihres Primärschlüssels aus der Datenbank.
	 * @param id Der Primärschlüssel der zu suchenden Sehenswürdigkeit.
	...
	/**
	 * Sucht alle Sehenswürdigkeiten aus der Datenbank, deren Name dem Suchstring entspricht.
	...
	/**
	 * Speichert eine Sehenswürdigkeit in der Datenbank. Diese Methode erkennt selbstständig, ob ein Objekt neu in die
	 * Datenbank eingefügt oder dort aktualisiert werden muss.
	 * @param sight Die zu speichernde Sehenswürdigkeit.
	 */
